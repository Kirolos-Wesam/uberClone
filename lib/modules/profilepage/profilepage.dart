                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: GooglePlaceAutoCompleteTextField(
                          ...
                          textEditingController:
                              cubit.businessAddressController,
                          googleAPIKey:
                              "AIzaSyCmxU2kB15GrRl30VBuH9H5X_2ra9jp0Kg",
                          textStyle: GoogleFonts.poppins(
                            fontSize: 16,
                    ...
                    SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            cubit.uploadProfileImageAndCreateAccount(
                              uId: uId,
                              name: cubit.nameController.text.toString(),
                              phoneNumber: '${cubit.countryCode.dialCode}${cubit.phoneNumberController.text.toString()}',
                              homeAddress:
                                  cubit.homeAddressController.text.toString(),
                              businessAddress: cubit
